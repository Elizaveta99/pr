...
import com.example.security.exception.ExpiredTokenAuthenticationException;
import com.example.security.exception.InvalidTokenAuthenticationException;
import com.example.security.model.JwtAuthenticationToken;
import com.example.security.model.JwtUserDetails;
import com.example.security.model.TokenPayload;
...
public class JwtAuthenticationProvider implements AuthenticationProvider {
    ...
    public Authentication authenticate(final Authentication authRequest) {
        ...
        User user = userRepository.findById(userEntityId.intValue());
